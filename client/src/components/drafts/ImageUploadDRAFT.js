...
const ImageUpload = () => {
  ...
  function handleUpload() {
    window.cloudinary.createUploadWidget(
      {
        cloudName: 'dsmdafpt0', //!this will be your cloud name - this should be in your .env
        uploadPreset: 'looseend', //!this will be your upload presets - this should be in your .env
        cropping: true
      },
      (err, result) => {
  ...
  function UploadedImage() {
    return <div><img src={formData.url}></img></div>
  }
