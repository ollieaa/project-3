export default function getPoiData(users) {
  return [
    ...
    },
    {
      ...
      time: '9:30a-3:30p/6p depending on the season',
      ...
      image: 'https://res.cloudinary.com/dnma7wqzb/image/upload/v1614184050/westminster_square_iyi0ly.jpg',
    ...
    {
      category: 'outdoor',
      name: 'Highgate Cemetary',
      tube: 'Archway',
      description: 'Highgate is one of seven new private cemetaries that were ordered to be built in the 19th century to bury London\'s dead, becoming one of the capital\'s most fashionable cemetaries. There are approximately 170,000 people buried in around 53,000 graves across the West Cemetery and the East Cemetery at Highgate Cemetery. It is listed as Grade I. Prominent interments include Douglas Adams, George Eliot, Karl Marx and Claudia Jones.',
      types: ['other', 'parks'],
      user: users[3],
      latlng: [
        51.5669,
    ...
    },
    {
      ...
      address: 'As it flows through London, there is no one specific address',
      price: 'Free',
      time: '24/7',
      phone: '',
      funfact: 'The railway from King\'s Cross Station goes under the canal and the railway from Euston station goes over the canal.',
      image: 'https://res.cloudinary.com/dnma7wqzb/image/upload/v1614185821/regents_hj76v2.jpg',
      link: 'https://canalrivertrust.org.uk/enjoy-the-waterways/canal-and-river-network/regents-canal',
      upVotes: 0,
      comments: [],
      events: []
    },
    {
      ...
      name: 'Seven Dials',
      tube: 'Covent Garden',
      description: 'A one of a kind destination hidden in the bustling heart of London. Set at a slower pace, the roads within Seven Dials are an escape from the busy streets of the city and home to 90 stores including world-renowned international flagships and concept locations, beauty and grooming boutiques as well as over 50 contemporary cafes, restaurants, bars and pubs.',
      types: ['other'],
      user: users[3],
      latlng: [
        51.5139,
      ...
      address: 'Long Acre, Covent Garden, London WC2E 9JT, United Kingdom',
      price: 'Free',
      time: 'Shop and restaurant hours will vary',
      phone: '',
      funfact: 'Today, only two houses remain from the original Thomas Neale development of the 1690s; 61 Monmouth Street and 64 Neal Street.',
      image: 'https://res.cloudinary.com/dnma7wqzb/image/upload/v1614186387/seven_dials_w3jfyd.jpg',
      link: 'https://www.sevendials.co.uk/',
      upVotes: 0,
      comments: [],
      events: []
    }
